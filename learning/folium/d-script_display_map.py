...
for f in glob.glob('%s/**/fair_ner.json' % path, recursive=False):
...
"""
width:100px; height:100px; background-color:blue; z-index:900;"""

"""
hmap.get_root().html.add_child(
    folium.Element(
    <div class="float-end">
        Testing! <div id='info'><\div>
    </div>
...
click_js = """function onClick(e) {
                 console.log(e);
                 //document.getElementById('offcanvas-body').innerHTML = '%s'
                 }""" % aux
